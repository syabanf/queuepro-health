...
const SUPABASE_URL = import.meta.env.VITE_SUPABASE_URL || 'https://juihnxnmwcgbflgjsuqa.supabase.co';
const SUPABASE_KEY = import.meta.env.VITE_SUPABASE_KEY || 'sb_publishable_a5NliuJ4q9sNAV5-dJFPzQ_1rSZAGAa';
